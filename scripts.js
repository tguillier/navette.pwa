(function(){HoneywellBarcodeReaderAjax=function(a,d){var f=this;if(!a||HoneywellBarcodeReaderUtils.stdParamCheck(a,"scannerName","string",d)){var e={method:"scanner.connect"};a&&(e.params={},e.params.scanner=a);HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",e,function(a){if(HoneywellBarcodeReaderUtils.hasProperty(a,"result",!0))if(HoneywellBarcodeReaderUtils.hasProperty(a.result,"session",!0)){f.sessionId=a.result.session;var k={method:"scanner.claim",params:{}};k.params.session=
f.sessionId;HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",k,function(a){HoneywellBarcodeReaderUtils.hasProperty(a,"result",!0)?HoneywellBarcodeReaderUtils.hasProperty(a.result,"filter",!0)?(f.filter=a.result.filter,HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:0,message:HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED})},0)):HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,
message:"JSON-RPC parsing error in response, missing filter parameter."})},0):HoneywellBarcodeReaderUtils.hasJsonRpcError(a)?HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:a.error.code,message:a.error.message})},0):HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,message:"JSON-RPC parsing error in response."})},0)})}else HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,
message:"JSON-RPC parsing error in response, missing session parameter."})},0);else HoneywellBarcodeReaderUtils.hasJsonRpcError(a)?HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:a.error.code,message:a.error.message})},0):HoneywellBarcodeReaderUtils.isFunction(d)&&setTimeout(function(){d({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,message:"JSON-RPC parsing error in response."})},0)})}};HoneywellBarcodeReaderAjax.prototype={version:"1.20.00.0334",sessionId:null,
filter:null,eventDispatcher:null,barcodeDataReadyListeners:[],batchGetBuffer:[],batchSetBuffer:[],addEventListener:function(a,d,f){function e(a,b,g){if("scanner.barcodeEvent"===a&&b&&g){var f=a=null,d=null,e,n;if(HoneywellBarcodeReaderUtils.hasProperty(b,"barcode",!0)&&(HoneywellBarcodeReaderUtils.hasProperty(b.barcode,"data",!0)&&(a=b.barcode.data),HoneywellBarcodeReaderUtils.hasProperty(b.barcode,"honeywellId",!0)&&(e=b.barcode.honeywellId),HoneywellBarcodeReaderUtils.hasProperty(b.barcode,"aimId",
!0)&&(n=b.barcode.aimId),f=HoneywellBarcodeReaderUtils.getSymbologyName(e,n),HoneywellBarcodeReaderUtils.hasProperty(b.barcode,"timestamp",!0)&&(d=b.barcode.timestamp),c.barcodeDataReadyListeners[g]instanceof Array))for(b=c.barcodeDataReadyListeners[g],g=0,e=b.length;g<e;g++)b[g](a,f,d)}}var c=this;c.filter&&(f={error:null,event:e,filter:c.filter},"barcodedataready"===a&&(c.eventDispatcher||(c.eventDispatcher=HoneywellBarcodeReaderWebEventDispatcher.create("datacollection"),c.eventDispatcher.startSession(f)),
"undefined"===typeof c.barcodeDataReadyListeners[c.filter]&&(c.barcodeDataReadyListeners[c.filter]=[]),c.barcodeDataReadyListeners[c.filter].push(d)))},clearBuffer:function(){this.batchGetBuffer.length=0;this.batchSetBuffer.length=0},close:function(a){var d=this;if(null===this.sessionId)HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a({status:0,message:"BarcodeReader already closed"})},0);else{var f={method:"scanner.release",params:{}};f.params.session=d.sessionId;HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",
f,function(f){HoneywellBarcodeReaderUtils.stdErrorCheck(f,function(c){if(0===c.status){d.filter=null;var f={method:"scanner.disconnect",params:{}};f.params.session=d.sessionId;HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",f,function(b){HoneywellBarcodeReaderUtils.stdErrorCheck(b,function(b){0===b.status&&(d.sessionId=null,d.eventDispatcher&&d.eventDispatcher.stopSession());HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a(b)},0)})})}else HoneywellBarcodeReaderUtils.isFunction(a)&&
setTimeout(function(){a(c)},0)})})}},commitBuffer:function(a){function d(){if(0<c.length){var b={method:"scanner.getProperties",params:{}};b.params.session=f.sessionId;b.params.names=[];for(var d=0,g=c.length;d<g;d++)b.params.names.push(c[d].command);f.logVar("Batch get request.params.names",b.params.names,!1);HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",b,function(b){f.logVar("Batch get's response",b,!1);if(HoneywellBarcodeReaderUtils.isFunction(a)){if(HoneywellBarcodeReaderUtils.hasProperty(b,
"result",!0))if(HoneywellBarcodeReaderUtils.hasProperty(b.result,"values",!0))for(var d=0,g=c.length;d<g;d++){var e=c[d],h={method:"getBuffered"};h.family=e.family;h.key=e.key;h.option=e.option;HoneywellBarcodeReaderUtils.hasProperty(b.result.values,e.command,!0)?HoneywellBarcodeReaderUtils.convertScannerSettingValue(e,b.result.values[e.command],h)?(h.status=0,h.message=HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED):(h.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,h.message="Unexpected scanner setting value"):
(h.status=HoneywellBarcodeReaderErrors.INVALID_PARAMETER,h.message="Invalid scanner property: "+e.command);k.push(h)}else h={method:"getBuffered",family:null,key:null,option:null},h.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,h.message="JSON-RPC parsing error in response.",k.push(h);else HoneywellBarcodeReaderUtils.hasJsonRpcError(b)?(h={method:"getBuffered",family:null,key:null,option:null},h.status=b.error.code,h.message=b.error.message):(h={method:"getBuffered",family:null,key:null,option:null},
h.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,h.message="JSON-RPC parsing error in response."),k.push(h);setTimeout(function(){a(k)},0)}})}else HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a(k)},0)}var f=this,e=[],c=[],k=[];if(null===this.sessionId||null===this.filter){if(HoneywellBarcodeReaderUtils.isFunction(a)){var b={};b.status=HoneywellBarcodeReaderErrors.NO_CONNECTION;b.message="No scanner connection";b.method=null;b.family=null;b.key=null;b.option=null;k.push(b);
setTimeout(function(){a(k)},0)}}else if(0===this.batchSetBuffer.length&&0===this.batchGetBuffer.length)HoneywellBarcodeReaderUtils.isFunction(a)&&(b={},b.status=HoneywellBarcodeReaderErrors.EMPTY_COMMIT_BUFFER,b.message="The commit buffer is empty, nothing to commit.",b.method=null,b.family=null,b.key=null,b.option=null,k.push(b),setTimeout(function(){a(k)},0));else{for(var g=0,l=f.batchSetBuffer.length;g<l;g++){var h=f.batchSetBuffer[g];0===h.status?e.push(h):(b={method:"setBuffered"},b.family=h.family,
b.key=h.key,b.option=h.option,b.status=h.status,b.message=h.message,k.push(b))}g=0;for(l=f.batchGetBuffer.length;g<l;g++)h=f.batchGetBuffer[g],0===h.status?c.push(h):(b={method:"getBuffered"},b.family=h.family,b.key=h.key,b.option=h.option,b.status=h.status,b.message=h.message,k.push(b));if(0<e.length){var m=[],b={method:"scanner.setProperties",params:{}};b.params.session=f.sessionId;b.params.values={};g=0;for(l=e.length;g<l;g++)h=e[g],b.params.values[h.command]=h.value,m.push(h.command);f.logVar("Batch set request.params.values",
b.params.values,!1);HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",b,function(b){if(HoneywellBarcodeReaderUtils.isFunction(a))if(HoneywellBarcodeReaderUtils.hasProperty(b,"result",!1))b={method:"scanner.getProperties",params:{}},b.params.session=f.sessionId,b.params.names=m,HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",b,function(b){f.logVar("Batch set's get response",b,!1);if(HoneywellBarcodeReaderUtils.hasProperty(b,"result",!0)&&HoneywellBarcodeReaderUtils.hasProperty(b.result,
"values",!0))for(var a=0,c=e.length;a<c;a++){var g=e[a],h={method:"setBuffered"};h.family=g.family;h.key=g.key;h.option=g.option;HoneywellBarcodeReaderUtils.hasProperty(b.result.values,g.command,!0)?b.result.values[g.command]===g.value?(h.status=0,h.message=HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED):(h.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,h.message="Scanner rejects the setting value."):(h.status=HoneywellBarcodeReaderErrors.INVALID_PARAMETER,h.message="Invalid scanner property: "+
g.command);k.push(h)}else HoneywellBarcodeReaderUtils.hasJsonRpcError(b)?(h={method:"setBuffered",family:null,key:null,option:null},h.status=b.error.code,h.message=b.error.message):(h={method:"setBuffered",family:null,key:null,option:null},h.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,h.message="JSON-RPC parsing error in response."),k.push(h);d()});else{if(HoneywellBarcodeReaderUtils.hasJsonRpcError(b)){var c={method:"setBuffered",family:null,key:null,option:null};c.status=b.error.code;c.message=
b.error.message}else c={method:"setBuffered",family:null,key:null,option:null},c.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,c.message="JSON-RPC parsing error in response.";k.push(c);d()}})}else d()}},enableTrigger:function(a,d){if(this.verifyActiveConnection(d)&&HoneywellBarcodeReaderUtils.stdParamCheck(a,"enabled","boolean",d)){var f={method:"scanner.setProperties",params:{}};f.params.session=this.sessionId;f.params.values={};f.params.values.TRIG_CONTROL_MODE=a?"autoControl":"disable";
HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",f,function(a){HoneywellBarcodeReaderUtils.stdErrorCheck(a,d)})}},get:function(a,d,f,e){var c=this,k,b;b={};b.family=a;b.key=d;b.option=f;HoneywellBarcodeReaderUtils.isFunction(e)&&("undefined"===typeof HowneywellBarcodeReaderSwiftSettings?(b.status=HoneywellBarcodeReaderErrors.MISSING_SETTINGS_DEF,b.message="Missing settings definition HowneywellBarcodeReaderSwiftSettings.",setTimeout(function(){e(b)},0)):null===this.sessionId||
null===this.filter?(b.status=HoneywellBarcodeReaderErrors.NO_CONNECTION,b.message="No scanner connection",setTimeout(function(){e(b)},0)):HoneywellBarcodeReaderUtils.stdParamCheckResult(a,"family","string",b,e)&&(HoneywellBarcodeReaderUtils.stdParamCheckResult(d,"key","string",b,e)&&HoneywellBarcodeReaderUtils.stdParamCheckResult(f,"option","string",b,e))&&(k=HoneywellBarcodeReaderUtils.getSettingDef(HowneywellBarcodeReaderSwiftSettings,a,d,f,null,!1),0===k.status?(a={method:"scanner.getProperties",
params:{}},a.params.session=c.sessionId,a.params.names=[],a.params.names.push(k.command),c.logVar("get settingDef",k,!1),HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",a,function(a){HoneywellBarcodeReaderUtils.hasProperty(a,"result",!0)?HoneywellBarcodeReaderUtils.hasProperty(a.result,"values",!0)?(a=a.result.values[k.command],c.logVar("get response scannerSettingValue",a,!0),HoneywellBarcodeReaderUtils.convertScannerSettingValue(k,a,b)?(b.status=0,b.message=HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED):
(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,b.message="Unexpected scanner setting value"),setTimeout(function(){e(b)},0)):(b.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,b.message="JSON-RPC parsing error in response."):(HoneywellBarcodeReaderUtils.hasJsonRpcError(a)?(b.status=a.error.code,b.message=a.error.message):(b.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,b.message="JSON-RPC parsing error in response."),setTimeout(function(){e(b)},0))})):(b.status=k.status,
b.message=k.message,setTimeout(function(){e(b)},0))))},getBuffered:function(a,d,f,e){var c;c={};c.family=a;c.key=d;c.option=f;"undefined"===typeof HowneywellBarcodeReaderSwiftSettings?HoneywellBarcodeReaderUtils.isFunction(e)&&(c.status=HoneywellBarcodeReaderErrors.MISSING_SETTINGS_DEF,c.message="Missing settings definition HowneywellBarcodeReaderSwiftSettings.",setTimeout(function(){e(c)},0)):null===this.sessionId||null===this.filter?HoneywellBarcodeReaderUtils.isFunction(e)&&(c.status=HoneywellBarcodeReaderErrors.NO_CONNECTION,
...
(c.status=0,c.message="Get request successfully buffered.",setTimeout(function(){e(c)},0)):HoneywellBarcodeReaderUtils.isFunction(e)&&(c.status=a.status,c.message=a.message,setTimeout(function(){e(c)},0)))},getLicenseInfo:function(a){if(HoneywellBarcodeReaderUtils.isFunction(a)){var d={method:"license.getLicenseInfo",params:{}};d.params.subsystem="datacollection";HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("license",d,function(d){HoneywellBarcodeReaderUtils.hasProperty(d,"result",!0)?(d.result.status=
0,d.result.message="Get license info completed successfully.",setTimeout(function(){a(d.result)},0)):HoneywellBarcodeReaderUtils.hasJsonRpcError(d)?setTimeout(function(){a({status:d.error.code,message:d.error.message})},0):setTimeout(function(){a({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,message:"JSON-RPC parsing error in response."})},0)})}},logVar:function(a,d,f){if(typeof HoneywellBarcodeReaderUtils.log===typeof Function){var e=typeof d;"object"===e?null!==d?"[object Array]"===Object.prototype.toString.call(d)?
(a=a+"\x3d"+d.toString(),f&&(a+=", type\x3dArray")):(a=a+"\x3d"+JSON.stringify(d,null," "),f&&(a+=", type\x3dobject")):(a+="\x3dnull",f&&(a+=", type\x3dobject")):"undefined"===e?(a+="\x3dundefined",f&&(a+=", type\x3dundefined")):(a=a+"\x3d"+d.toString(),f&&(a+=", type\x3d"+e));HoneywellBarcodeReaderUtils.log(a)}},removeEventListener:function(a,d){if(this.filter&&"barcodedataready"===a&&this.barcodeDataReadyListeners[this.filter]instanceof Array)for(var f=this.barcodeDataReadyListeners[this.filter],
e=0,c=f.length;e<c;e++)if(f[e]===d){f.splice(e,1);break}},set:function(a,d,f,e,c){var k=this,b,g;g={};g.family=a;g.key=d;g.option=f;"undefined"===typeof HowneywellBarcodeReaderSwiftSettings?HoneywellBarcodeReaderUtils.isFunction(c)&&(g.status=HoneywellBarcodeReaderErrors.MISSING_SETTINGS_DEF,g.message="Missing settings definition HowneywellBarcodeReaderSwiftSettings.",setTimeout(function(){c(g)},0)):null===this.sessionId||null===this.filter?HoneywellBarcodeReaderUtils.isFunction(c)&&(g.status=HoneywellBarcodeReaderErrors.NO_CONNECTION,
g.message="No scanner connection",setTimeout(function(){c(g)},0)):HoneywellBarcodeReaderUtils.stdParamCheckResult(a,"family","string",g,c)&&(HoneywellBarcodeReaderUtils.stdParamCheckResult(d,"key","string",g,c)&&HoneywellBarcodeReaderUtils.stdParamCheckResult(f,"option","string",g,c)&&HoneywellBarcodeReaderUtils.stdParamCheckResult(e,"value","string",g,c))&&(b=HoneywellBarcodeReaderUtils.getSettingDef(HowneywellBarcodeReaderSwiftSettings,a,d,f,e,!0),0===b.status?(a={method:"scanner.setProperties",
params:{}},a.params.session=k.sessionId,a.params.values={},a.params.values[b.command]=b.value,k.logVar("set settingDef",b,!1),k.logVar("set request.params.values",a.params.values,!1),HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",a,function(a){HoneywellBarcodeReaderUtils.isFunction(c)&&(HoneywellBarcodeReaderUtils.hasProperty(a,"result",!1)?(a={method:"scanner.getProperties",params:{}},a.params.session=k.sessionId,a.params.names=[],a.params.names.push(b.command),HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",
a,function(a){k.logVar("set function get response",a,!1);HoneywellBarcodeReaderUtils.hasProperty(a,"result",!0)&&HoneywellBarcodeReaderUtils.hasProperty(a.result,"values",!0)?HoneywellBarcodeReaderUtils.hasProperty(a.result.values,b.command,!0)?a.result.values[b.command]===b.value?(g.status=0,g.message=HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED):(g.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,g.message="Scanner rejects the setting value."):(g.status=HoneywellBarcodeReaderErrors.INVALID_PARAMETER,
g.message="Invalid scanner property: "+b.command):HoneywellBarcodeReaderUtils.hasJsonRpcError(a)?(g.status=a.error.code,g.message=a.error.message):(g.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,g.message="JSON-RPC parsing error in response.");setTimeout(function(){c(g)},0)})):(HoneywellBarcodeReaderUtils.hasJsonRpcError(a)?(g.status=a.error.code,g.message=a.error.message):(g.status=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,g.message="JSON-RPC parsing error in response."),setTimeout(function(){c(g)},
0)))})):HoneywellBarcodeReaderUtils.isFunction(c)&&(g.status=b.status,g.message=b.message,setTimeout(function(){c(g)},0)))},setBuffered:function(a,d,f,e,c){var k;k={};k.family=a;k.key=d;k.option=f;"undefined"===typeof HowneywellBarcodeReaderSwiftSettings?HoneywellBarcodeReaderUtils.isFunction(c)&&(k.status=HoneywellBarcodeReaderErrors.MISSING_SETTINGS_DEF,k.message="Missing settings definition HowneywellBarcodeReaderSwiftSettings.",setTimeout(function(){c(k)},0)):null===this.sessionId||null===this.filter?
...
a,d,f,e,!0),this.logVar("setBuffered settingDef",a,!1),this.batchSetBuffer.push(a),0===a.status?HoneywellBarcodeReaderUtils.isFunction(c)&&(k.status=0,k.message="Set request successfully buffered.",setTimeout(function(){c(k)},0)):HoneywellBarcodeReaderUtils.isFunction(c)&&(k.status=a.status,k.message=a.message,setTimeout(function(){c(k)},0)))},verifyActiveConnection:function(a){return null===this.sessionId||null===this.filter?(HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a({status:HoneywellBarcodeReaderErrors.NO_CONNECTION,
message:"No scanner connection"})},0),!1):!0}};HoneywellBarcodeReadersAjax=function(a){HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a({status:0,message:HoneywellBarcodeReaderUtils.MSG_OPERATION_COMPLETED})},0)};HoneywellBarcodeReadersAjax.prototype={version:"1.20.00.0334",getAvailableBarcodeReaders:function(a){function d(c){if(HoneywellBarcodeReaderUtils.hasProperty(c,"result",!0)&&HoneywellBarcodeReaderUtils.hasProperty(c.result,"scanners",!0)&&c.result.scanners instanceof Array)for(var b=
0,d=c.result.scanners.length;b<d;b++)HoneywellBarcodeReaderUtils.hasProperty(c.result.scanners[b],"scanner",!0)&&f.push(c.result.scanners[b].scanner);0===f.length&&f.push("dcs.scanner.imager");HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a(f)},0)}var f=[],e={method:"scanner.listConnectedScanners"};if(HoneywellBarcodeReaderUtils.isFunction(a))HoneywellBarcodeReaderUtils.sendJsonRpcRequestSubSys("datacollection",e,d);else{var c;e.id=HoneywellBarcodeReaderUtils.getRandomInt(1E4,99999);
e.jsonrpc="2.0";window.XMLHttpRequest&&(c=new XMLHttpRequest,c.onreadystatechange=function(){if(4==c.readyState&&200==c.status){var a;try{a=JSON.parse(c.responseText),d(a)}catch(b){}}},c.open("POST","http://127.0.0.1:8080/jsonrpc/datacollection",!1),c.send(JSON.stringify(e)))}return f}}})();
...
getRandomInt:function(a,d){return Math.floor(Math.random()*(d-a+1))+a},getSettingDef:function(a,d,e,g,c,h){var b={},l=!1;b.status=0;b.message=this.MSG_OPERATION_COMPLETED;b.family=d;b.key=e;b.option=g;if(a&&a instanceof Array){for(var n=0,m=a.length;n<m&&0===b.status;n++){var f=a[n];if(this.hasProperty(f,"family",!0)&&f.family===d&&(l||(l=!0),this.hasProperty(f,"key",!0)&&f.key===e&&this.hasProperty(f,"option",!0)&&f.option===g)){if(this.hasProperty(f,"command",!0))b.command=f.command;else{b.status=
HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF;b.message="Setting definition missing command property.";break}if(this.hasProperty(f,"valueType",!0))if(b.valueType=f.valueType,"map"===f.valueType){if(this.hasProperty(f,"valueMap",!0))if(f.valueMap instanceof Array){if(b.valueMap=f.valueMap,h)if("undefined"!==typeof c){for(var k=0,p=f.valueMap.length;k<p;k++)if(this.hasProperty(f.valueMap[k],c,!0)){b.value=f.valueMap[k][c];break}"undefined"===typeof b.value&&(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,
b.message="Invalid setting value.")}else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,b.message="Invalid setting value."}else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Settings definition has invalid valueMap property, not an array.";else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Settings definition missing valueMap property for map type.";this.hasProperty(f,"reverseValueMap",!0)&&(f.reverseValueMap instanceof Array?b.reverseValueMap=
f.reverseValueMap:(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Settings definition has invalid reverseValueMap property, not an array."))}else if("int"===f.valueType)this.hasProperty(f,"valueRange",!0)?f.valueRange instanceof Array?(b.valueRange=f.valueRange,h&&(c&&!isNaN(c)?b.value=parseInt(c):(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,b.message="Invalid setting value, not a number."))):(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message=
"Setting definition has invalid valueRange property, not an array."):(b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Setting definition missing valueRange property for int type.");else if("string"===f.valueType)h&&(b.value=c);else if("list"===f.valueType)if(this.hasProperty(f,"values",!0))if(f.values instanceof Array){if(b.values=f.values,h)if("undefined"!==typeof c){k=0;for(p=f.values.length;k<p;k++)if(f.values[k]===c){b.value=c;break}"undefined"===typeof b.value&&(b.status=
HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,b.message="Invalid setting value.")}else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTING_VALUE,b.message="Invalid setting value."}else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Setting definition has invalid values property, not an array.";else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Setting definition missing values property for list type.";else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,
b.message="Unsupported setting value data type: "+f.valueType;else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message="Setting definition missing valueType property."}}0!==b.status||b.command||(l?(b.status=HoneywellBarcodeReaderErrors.UNSUPPORTED_KEY_OR_OPTION,b.message="Unsupported key or option name"):(b.status=HoneywellBarcodeReaderErrors.UNSUPPORTED_FAMILY_NAME,b.message="Unsupported family name: "+d))}else b.status=HoneywellBarcodeReaderErrors.INVALID_SETTINGS_DEF,b.message=
"Invalid settings definition object, needs to be an array.";return b},getSymbologyName:function(a,d){var e="",g=HoneywellSymbologyIDTable.length,c,h=0;if(!a)return e;for(c=0;c<g;c++)if(a===HoneywellSymbologyIDTable[c].honeywellId){e=HoneywellSymbologyIDTable[c].name;h=c;break}if(e&&d&&"j"===a)for(c=h;c<g;c++)if(1===d.indexOf(HoneywellSymbologyIDTable[c].aimId,1)){e=HoneywellSymbologyIDTable[c].name;break}return e},hasJsonRpcError:function(a){return"object"===typeof a&&a.hasOwnProperty("error")&&a.error?
a.error.hasOwnProperty("code")&&a.error.hasOwnProperty("message"):!1},hasProperty:function(a,d,e){return"object"===typeof a&&a.hasOwnProperty(d)?e?null!==a[d]:!0:!1},isFunction:function(a){return typeof a==typeof Function},loadJavaScript:function(a,d){var e=document.createElement("script");e.setAttribute("type","text/javascript");e.setAttribute("src",a);this.isFunction(d)&&(e.onload=d);document.getElementsByTagName("head")[0].appendChild(e)},sendJsonRpcRequestSubSys:function(a,d,e){var g=this,c,h=
this.getRandomInt(1E4,99999);d.id=h;d.jsonrpc="2.0";if(window.XMLHttpRequest)c=new XMLHttpRequest,c.onreadystatechange=function(){if(4==c.readyState)if(200==c.status){var b;try{b=JSON.parse(c.responseText)}catch(a){g.isFunction(e)&&(b={jsonrpc:"2.0"},b.id=h,b.error={},b.error.code=HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,b.error.message="JSON-RPC parsing error in response.",setTimeout(function(){e(b)},0));return}h==b.id&&g.isFunction(e)&&setTimeout(function(){e(b)},0)}else g.isFunction(e)&&(b=
{jsonrpc:"2.0"},b.id=h,b.error={},b.error.code=HoneywellBarcodeReaderErrors.WEB_SERVICE_NOT_RESPONDING,b.error.message="Web service not responding.",setTimeout(function(){e(b)},0))},c.open("POST","http://127.0.0.1:8080/jsonrpc/"+a,!0),c.send(JSON.stringify(d));else if(g.isFunction(e)){var b={jsonrpc:"2.0"};b.id=h;b.error={};b.error.code=HoneywellBarcodeReaderErrors.AJAX_NOT_SUPPORTED;b.error.message="Browser does not support XMLHttpRequest";setTimeout(function(){e(b)},0)}},setup:function(){var a=
this;a.bridgeType||("undefined"!==typeof win10EnterpriseBrowserInfo?(a.bridgeType=a.BRIDGE_TYPE_NATIVE_WINRT_OBJECT,"undefined"===typeof HoneywellBarcodeReaderSwiftWin&&a.loadJavaScript("BarcodeReader-Swift-Win.js",function(){a.barcodeReaderObjName="HoneywellBarcodeReaderSwiftWin"}),"undefined"===typeof HowneywellBarcodeReaderSwiftSettings&&a.loadJavaScript("BarcodeReader-SwiftSettings.js"),"undefined"===typeof HowneywellBarcodeReaderRingSettings&&a.loadJavaScript("BarcodeReader-WinRingSettings.js")):
!1==a.checkNpapiPlugin()&&a.sendJsonRpcRequestSubSys("datacollection",{method:"scanner.getInfo"},function(d){if(a.hasProperty(d,"result",!0)||a.hasJsonRpcError(d))a.bridgeType=a.BRIDGE_TYPE_AJAX,"undefined"===typeof HoneywellBarcodeReaderAjax&&a.loadJavaScript("BarcodeReader-Ajax.js",function(){a.barcodeReaderObjName="HoneywellBarcodeReaderAjax"}),"undefined"===typeof HowneywellBarcodeReaderSwiftSettings&&a.loadJavaScript("BarcodeReader-SwiftSettings.js")}))},stdParamCheck:function(a,d,e,g){if(typeof a===
e)return!0;this.isFunction(g)&&setTimeout(function(){g({status:HoneywellBarcodeReaderErrors.INVALID_PARAMETER,message:"Invalid parameter: "+d+", must be "+e})},0);return!1},stdParamCheckResult:function(a,d,e,g,c){if(typeof a===e)return!0;this.isFunction(c)&&(g?(g.status=HoneywellBarcodeReaderErrors.INVALID_PARAMETER,g.message="Invalid parameter: "+d+", must be "+e,setTimeout(function(){c(g)},0)):setTimeout(function(){c({status:HoneywellBarcodeReaderErrors.INVALID_PARAMETER,message:"Invalid parameter: "+
d+", must be "+e})},0));return!1},stdErrorCheck:function(a,d){var e=this;if(this.hasProperty(a,"result",!1))return this.isFunction(d)&&setTimeout(function(){d({status:0,message:e.MSG_OPERATION_COMPLETED})},0),!0;this.hasJsonRpcError(a)?this.isFunction(d)&&setTimeout(function(){d({status:a.error.code,message:a.error.message})},0):this.isFunction(d)&&setTimeout(function(){d({status:HoneywellBarcodeReaderErrors.JSON_PARSE_ERROR,message:"JSON-RPC parsing error in response."})},0);return!1}},HoneywellBarcodeReaderErrors=
...
get NO_AVAILABLE_BRIDGE(){return this.formatError(this.ERROR_CODE_BASE+1)},get AJAX_NOT_SUPPORTED(){return this.formatError(this.ERROR_CODE_BASE+2)},get WEB_SERVICE_NOT_RESPONDING(){return this.formatError(this.ERROR_CODE_BASE+3)},get MISSING_SETTINGS_DEF(){return this.formatError(this.ERROR_CODE_BASE+4)},get INVALID_SETTINGS_DEF(){return this.formatError(this.ERROR_CODE_BASE+5)},get EMPTY_COMMIT_BUFFER(){return this.formatError(this.ERROR_CODE_BASE+6)},formatError:function(a){var d=0;0!=a&&0==(a&
4294901760)&&(d=2147483648|this.JS_BARCODE_READER_FACILITY_CODE<<16|a);return d}},HoneywellSymbologyIDTable=[{name:"AUSTRALIAPOST",honeywellId:"A",aimId:"X0"},{name:"AZTEC",honeywellId:"z",aimId:"z3"},{name:"BPO",honeywellId:"B",aimId:"X0"},{name:"CANADAPOST",honeywellId:"C",aimId:"X0"},{name:"CODABAR",honeywellId:"a",aimId:"F0"},{name:"CodablockA",honeywellId:"V",aimId:"O6"},{name:"CodablockF",honeywellId:"q",aimId:"O4"},{name:"Code11",honeywellId:"h",aimId:"H1"},{name:"Code39",honeywellId:"b",aimId:"A0"},
{name:"Code93",honeywellId:"i",aimId:"G0"},{name:"Code128",honeywellId:"j",aimId:"C0"},{name:"GS1_128",honeywellId:"I",aimId:"C1"},{name:"ISBT128",honeywellId:"j",aimId:"C4"},{name:"DATAMATRIX",honeywellId:"w",aimId:"d1"},{name:"EAN8",honeywellId:"D",aimId:"E4"},{name:"EAN13",honeywellId:"d",aimId:"E0"},{name:"CHINAPOST",honeywellId:"Q",aimId:"X0"},{name:"DUTCHPOST",honeywellId:"K",aimId:"X0"},{name:"GS1EX",honeywellId:"}",aimId:"e0"},{name:"GS1LI",honeywellId:"{",aimId:"e0"},{name:"GS1OD",honeywellId:"y",
aimId:"e0"},{name:"HANXIN",honeywellId:"H",aimId:"X0"},{name:"INFOMAIL",honeywellId:",",aimId:"X0"},{name:"INTELLIGENTMAIL",honeywellId:"M",aimId:"X0"},{name:"ITF",honeywellId:"e",aimId:"I0"},{name:"ITFMatrix",honeywellId:"m",aimId:"X0"},{name:"ITFStandard",honeywellId:"f",aimId:"S0"},{name:"JAPANPOST",honeywellId:"J",aimId:"X0"},{name:"KOREANPOST",honeywellId:"?",aimId:"X0"},{name:"MAXICODE",honeywellId:"x",aimId:"U0"},{name:"MICROPDF",honeywellId:"R",aimId:"L0"},{name:"MSI",honeywellId:"g",aimId:"M0"},
{name:"PDF417",honeywellId:"r",aimId:"L0"},{name:"PLANET",honeywellId:"L",aimId:"X0"},{name:"POSTNET",honeywellId:"P",aimId:"X0"},{name:"QR",honeywellId:"s",aimId:"Q1"},{name:"SWEDENPOST",honeywellId:"[",aimId:"X0"},{name:"TELEPEN",honeywellId:"t",aimId:"B1"},{name:"TLC39",honeywellId:"T",aimId:"L2"},{name:"TRIOPTIC",honeywellId:"\x3d",aimId:"X0"},{name:"UPCA",honeywellId:"c",aimId:"E0"},{name:"UPCE",honeywellId:"E",aimId:"E0"}],HoneywellBarcodeReaderWebEventDispatcher={defaultScannerName:"dcs.scanner.imager",
create:function(a){function d(b,g){if(typeof HoneywellBarcodeReaderUtils.log===typeof Function){var a=b?b+" ":"";"object"===typeof g?HoneywellBarcodeReaderUtils.log(a+JSON.stringify(g)):HoneywellBarcodeReaderUtils.log(a+g)}}var e="http://127.0.0.1:8080/jsonrpc/"+a+"/events",g=!1,c=null,h=null,b=1,l=function(){},n=function(){},m,f,k,p=function(){f||("undefined"!==typeof document.webkitHidden?(f="webkitHidden",k="webkitvisibilitychange"):"undefined"!==typeof document.hidden&&(f="hidden",k="visibilitychange"));
f&&"undefined"!==typeof document.addEventListener&&!m&&(m=function(){document[f]||(g=!0,q(),d("handleDocVisibilityChangeEvent","requestEvents"))},document.addEventListener(k,m,!1))},r=function(b){b!=g&&(g=b)&&q();b?p():m&&(document.removeEventListener(k,m),m=null)},q=function(){var a=new XMLHttpRequest;a.open("POST",e,!0);a.setRequestHeader("Content-Type","application/json");a.onreadystatechange=function(){var b;if(4==a.readyState)if(200==a.status)try{if(b=JSON.parse(a.responseText),HoneywellBarcodeReaderUtils.hasProperty(b,
"result",!0)){var e=b.result.session;e&&(c=e);if(HoneywellBarcodeReaderUtils.hasProperty(b.result,"events",!0)){0<b.result.events.length&&d("Barcode event response:",b);var f,k;for(f=0;f<b.result.events.length;f++)k=b.result.events[f],l(k.method,k.params,h)}g&&q()}else b.error&&(n(b.error.code,b.error.message),d("events.getNext error response:","code: "+b.error.code+" message: "+b.error.message))}catch(m){d("Failed to handle response",a.responseText),n(-1,m.message),g=!1}else d("HTTP error","status "+
a.status+" "+a.statusText),n(a.status,a.statusText),g=!1};var f={id:b++,jsonrpc:"2.0",method:"events.getNext",params:{timeout:s.eventTimeout}};c&&(f.params.session=c);null!==h&&(f.params.filter=h);try{a.send(JSON.stringify(f))}catch(k){n(a.status,a.statusText),g=!1}},s={eventTimeout:60,startSession:function(b){l=HoneywellBarcodeReaderUtils.hasProperty(b,"event",!0)?b.event:function(){};n=HoneywellBarcodeReaderUtils.hasProperty(b,"error",!0)?b.error:function(){};h=HoneywellBarcodeReaderUtils.hasProperty(b,
"filter",!0)?b.filter:null;r(!0);d(null,"Event session started")},stopSession:function(){r(!1);d(null,"Event session stopped")}};return s}};
(function(a){var d=0;HoneywellBarcodeReaderUtils.setup();var e=function(a){HoneywellBarcodeReaderUtils.barcodeReaderObjName?setTimeout(function(){a()},0):5E3>d?(d+=100,setTimeout(function(){e(a)},100)):setTimeout(function(){a()},0)};a.BarcodeReader=function(a,c){var d=this;e(function(){HoneywellBarcodeReaderUtils.barcodeReaderObjName?"HoneywellBarcodeReaderSwiftWin"===HoneywellBarcodeReaderUtils.barcodeReaderObjName?d.barcodeReader=new HoneywellBarcodeReaderSwiftWin(a,c):"HoneywellBarcodeReaderAjax"===
HoneywellBarcodeReaderUtils.barcodeReaderObjName?d.barcodeReader=new HoneywellBarcodeReaderAjax(a,c):HoneywellBarcodeReaderUtils.isFunction(c)&&setTimeout(function(){c({status:HoneywellBarcodeReaderErrors.NO_AVAILABLE_BRIDGE,message:"No available JavaScript to Native bridge found."})},0):HoneywellBarcodeReaderUtils.isFunction(c)&&setTimeout(function(){c({status:HoneywellBarcodeReaderErrors.NO_AVAILABLE_BRIDGE,message:"No available JavaScript to Native bridge found."})},0)})};a.BarcodeReader.prototype=
...
"undefined"!==typeof this.barcodeReader.clearBuffer&&this.barcodeReader.clearBuffer()},close:function(a){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.close?this.barcodeReader.close(a):HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},commitBuffer:function(a){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.commitBuffer?this.barcodeReader.commitBuffer(a):HoneywellBarcodeReaderUtils.isFunction(a)&&
setTimeout(function(){a({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},directIO:function(a,c){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.directIO?this.barcodeReader.directIO(a,c):HoneywellBarcodeReaderUtils.isFunction(c)&&setTimeout(function(){c({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},enableTrigger:function(a,c){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.enableTrigger?
this.barcodeReader.enableTrigger(a,c):HoneywellBarcodeReaderUtils.isFunction(c)&&setTimeout(function(){c({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},get:function(a,c,d,b){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.get?this.barcodeReader.get(a,c,d,b):HoneywellBarcodeReaderUtils.isFunction(b)&&setTimeout(function(){b({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},getBuffered:function(a,
c,d,b){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.getBuffered?this.barcodeReader.getBuffered(a,c,d,b):HoneywellBarcodeReaderUtils.isFunction(b)&&setTimeout(function(){b({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},getLicenseInfo:function(a){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.getLicenseInfo?this.barcodeReader.getLicenseInfo(a):HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,
message:"Method is not supported"})},0)},removeEventListener:function(a,c){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.removeEventListener&&this.barcodeReader.removeEventListener(a,c)},set:function(a,c,d,b,e){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.set?this.barcodeReader.set(a,c,d,b,e):HoneywellBarcodeReaderUtils.isFunction(e)&&setTimeout(function(){e({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)},setBuffered:function(a,
c,d,b,e){this.barcodeReader&&"undefined"!==typeof this.barcodeReader.setBuffered?this.barcodeReader.setBuffered(a,c,d,b,e):HoneywellBarcodeReaderUtils.isFunction(e)&&setTimeout(function(){e({status:HoneywellBarcodeReaderErrors.FEATURE_NOT_SUPPORTED,message:"Method is not supported"})},0)}};a.BarcodeReaders=function(a){var c=this;e(function(){HoneywellBarcodeReaderUtils.barcodeReaderObjName?"HoneywellBarcodeReaderSwiftWin"===HoneywellBarcodeReaderUtils.barcodeReaderObjName?c.barcodeReaders=new HoneywellBarcodeReadersSwiftWin(a):
...
0)})};a.BarcodeReaders.prototype={version:"1.20.00.0334",barcodeReaders:null,getAvailableBarcodeReaders:function(a){var c;this.barcodeReaders&&"undefined"!==typeof this.barcodeReaders.getAvailableBarcodeReaders?c=this.barcodeReaders.getAvailableBarcodeReaders(a):(c=[],HoneywellBarcodeReaderUtils.isFunction(a)&&setTimeout(function(){a(c)},0));return c}}})(this);
;
